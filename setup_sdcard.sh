...
while true; do
    ...
    case $choice in 
        ...
        su
        echo "sudo mount -o remount,exec /Download" >>~/ubuntu/root/.bashrc
        echo "alias sd=cd /Download/"»~/ubuntu/root/.bashrc
        echo "alias debug64=WINEPREFIX=~/.wine box64 wine" »~/ubuntu/root/.bashrc
        echo "alias debug32=WINEPREFIX=~/.wine box86 wine" »~/ubuntu/root/.bashrc
        echo "alias sd=cd /Download/"»~/ubuntu/root/.bashrc
        echo "alias debug64all=WINEDEBUG=-all WINEPREFIX=~/.wine box64 wine" »~/ubuntu/root/.bashrc
        echo "alias debug32all=WINEDEBUG=-all WINEPREFIX=~/.wine box86 wine" »~/ubuntu/root/.bashrc
        exit
        rm ~/setup_sdcard
